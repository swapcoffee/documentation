...
If you are interested in adding new asset to the **swap.coffee DEX**, first of you you must create a **Vault** for it.
...
Keep in mind that pools with AMM strategies other than **Volatile** may be created by **DEX** administration only.
