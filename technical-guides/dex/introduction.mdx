...
**swap.coffee DEX** is an open-source\* most powerful and extensible decentralized exchange **TON**-native protocol
...
\* At the time reader is going through this documentation, **swap.coffee DEX** is still in closed testing or early adoption stage.
Once the protocol will pass the audit, and we will be satisfied with all identified issues being fixed, a repository
containing the code for all contracts, tests and wrappers will be released to the public.