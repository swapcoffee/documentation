---
title: 'Staking API'
description: 'Technical documentation for tokens with staking information and the API for building stake/unstake transactions'
icon: 'wand-magic-sparkles'
---

# Introduction

Tokens in the swap.coffee platform can have associated staking pools. The staking pool information is represented by the `stackingPool` object, which contains details about the staking pool, such as the address, name, APY, and other relevant information.
